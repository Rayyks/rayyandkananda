import { PROJECT_STUDY1, PROJECT_STUDY2 } from "@/config";
...
export default function ProjectStudy() {
  const project1 = PROJECT_STUDY1;
  const project2 = PROJECT_STUDY2;
  return (
    <MaxWidthWrapper className="py-10 md:py-20">
      <h2 className="text-4xl font-bold">On going project</h2>
      <p className="text-muted-foreground mt-1 mb-4">
        A deep dive into a recent project.
      </p>
      <div className="flex gap-8 flex-col">
        <Link href={project1.href} target="_blank">
        ...
        <Link href={project2.href} target="_blank">
