    ...
    <Card className="h-full">
      <CardHeader>
        ...
        <div className="flex flex-col gap-2 *:text-muted-foreground *:flex *:items-center">
          <Link
            href="mailto:rayydna14@gmail.com"
            target="_blank"
          ...
          <Link href="https://www.linkedin.com/in/rayynd/">
            <Linkedin size={18} className="mr-3" />
            Rayyand Kananda
          </Link>
          <Link href="https://buymeacoffee.com/rayydna14g">
            <CoffeeIcon size={18} className="mr-3" />
            Buy me a coffee
          </Link>
          <Link href="https://twitter.com/rayy__and/">
            <svg
